...
function capture (instance, index, list) {
  ...
  if (instance.fnContext && !instance.componentInstance) {
    ...
    return {
      ...
      name,
      file,
      isBusinessComponent: isBusinessComponent({ name, file }),
...
function getInstanceDetails (id) {
  ...
  if (!instance) {
    ...
    const name = getComponentName(vnode.fnOptions)
    const file = vnode.fnOptions.__file || null
    const data = {
      id,
      name,
      file,
...
export function getInstanceFile (instance) {
  if (instance.fnOptions && instance.fnOptions.__file) {
    return instance.fnOptions.__file
  }
  ...
  let options
  if ((options = instance.$vnode) && (options = options.componentOptions) && (options = options.Ctor) && (options = options.options)) {
    return options.__file || null
  }
